...
export default function ScanPage() {
  ...
  return (
    <main className="min-h-screen w-full min-w-0 overflow-x-hidden bg-[#f7f8f8]">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <select
                      ...
                      className="h-12 min-w-0 w-full cursor-pointer appearance-none rounded-xl border border-[#cbd5d3] bg-white pl-11 pr-4 text-base outline-none transition focus:border-[#004e47] focus:ring-2 focus:ring-[#004e47]/10"
                    >
                      {MEAL_TYPES.map(
                        (type) => (
                          <option
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="h-12 min-w-0 w-full cursor-pointer rounded-xl border border-[#cbd5d3] bg-white pl-11 pr-2 text-base outline-none focus:border-[#004e47] focus:ring-2 focus:ring-[#004e47]/10 sm:pr-4"
                    />
                ...
                <div>
                  ...
                  {editing ? (
                    <select
                      ...
                      className="h-12 min-w-0 w-full cursor-pointer rounded-xl border border-[#cbd5d3] bg-white px-4 text-base outline-none focus:border-[#004e47] focus:ring-2 focus:ring-[#004e47]/10"
                    >
                      {MEAL_TYPES.map(
                        (type) => (
                          <option
                    ...
                    <div className="rounded-xl bg-[#f3f6f5] p-3 text-sm font-semibold text-[#004e47]">
                      {formatMealType(analysis.meal_type)}
                    </div>
                  )}
                </div>
                ...
                <div>
                  ...
                  {editing ? (
                    <input
                      ...
                      className="h-12 min-w-0 w-full rounded-xl border border-[#cbd5d3] px-4 text-base outline-none focus:border-[#004e47] focus:ring-2 focus:ring-[#004e47]/10"
                    />
                  ) : (
                ...
                <div>
                  ...
                  {editing ? (
                    <textarea
                      ...
                      rows={4}
                      className="w-full resize-none rounded-xl border border-[#cbd5d3] p-4 text-base outline-none focus:border-[#004e47] focus:ring-2 focus:ring-[#004e47]/10"
                    />
                  ) : (
