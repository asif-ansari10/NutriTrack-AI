...
export async function getDiaryData(
  ...
  /* ==========================================================
     ...
     If no date is provided, use today's India date.
  ========================================================== */
  ...
  const profile = rawProfile
    ? {
        ...
        currentWeight:
          Number(
            rawProfile.current_weight_kg
          ) || 0,

        targetWeight:
          Number(
            rawProfile.target_weight_kg
          ) || 0,

        dailyCalorieTarget:
          Number(
            rawProfile.daily_calorie_target
          ) || 0,

        proteinTarget:
          Number(
            rawProfile.protein_target_g
          ) || 0,

        carbsTarget:
          Number(
            rawProfile.carbs_target_g
          ) || 0,

        fatTarget:
          Number(
            rawProfile.fat_target_g
          ) || 0,
        ...
        heightCm:
          rawProfile.height_cm == null
            ? null
            : Number(
                rawProfile.height_cm
              ),

        activityLevel:
          rawProfile.activity_level ||
          null,
      }
    : null;
  ...
  /* ==========================================================
     ...
     This is calculated from the user's
